      ...
      <section className="grid grid-cols-2 mt-4z content-center">
        <div className="col-span-2 md:col-span-1 p-4">
          <div className="bg-gray-300 rounded-lg shadow-lg p-4 mb-4">
            <h3 className="  text-center items-center font-serif text-black">
              Hotel Booking System
            </h3>
            <img className="h-90 w-90 rounded-sm" src={list} alt="project 2" />
            <p>
              Built an Todo list web App using reactjs, tailwindcss this App
        ...
        <div className="col-span-2 md:col-span-1 p-4">
          <div className="bg-gray-300 rounded-lg shadow-lg p-4 mb-4">
            <h3 className="  text-center items-center font-serif text-slate-700">
              Weather App
            </h3>

            <img className="h-90 w-90 rounded-sm" src={cast} alt="project 1" />
            <p>
              Built an Weather web App using reactjs, tailwindcss and weather
              API, this App allows users to check on their the forecast at at
              their preffered Location.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-2 md:col-span-1 p-4">
          <div className="bg-gray-300 rounded-lg shadow-lg p-4 mb-4">
            ...
            <p>
              Built an Weather web App using reactjs, tailwindcss and weather
              API, this App allows users to Register, Login to the system and
              book accomodation, see available rooms, check on services
            </p>
          </div>
        </div>
      </section>
